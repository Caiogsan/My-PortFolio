    ...
    return (
        <div className="text-center mt-8 mb-8 min-h-[500px] flex flex-col ">
            <div className="flex">
                ...
                <h1 className="pr-8 w-full text-2xl font-merienda">Hey <strong>{name}</strong>!! Welcome to my personal space!!</h1>
            </div>
